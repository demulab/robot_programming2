...
int main(int argc, char **argv)
{
  ...
  pub_joint2 = nh.advertise<std_msgs::Float64>("/armbot2/joint2_position_controller/command", 100);
  sub_sensor = nh.subscribe<nav_msgs::Odometry>("/armbot2/pose_ground_truth", 100, groundTruthCallback);
